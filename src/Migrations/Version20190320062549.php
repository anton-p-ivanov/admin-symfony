 ...
 */
final class Version20190320062549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE storage_files (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', workflow_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', name VARCHAR(255) NOT NULL, size INT NOT NULL, type VARCHAR(255) NOT NULL, hash CHAR(32) NOT NULL, UNIQUE INDEX UNIQ_6BE1897994E0409D (workflow_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users_accounts (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', user_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', account_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', position VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B189B576ABFE1C6F (user_uuid), INDEX IDX_B189B5765DECD70C (account_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE accounts (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', workflow_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(255) NOT NULL, description MEDIUMTEXT DEFAULT NULL, is_active TINYINT(1) DEFAULT \'1\' NOT NULL, email VARCHAR(255) NOT NULL, web VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, sort INT DEFAULT 100 NOT NULL, UNIQUE INDEX UNIQ_CAC89EACE7927C74 (email), UNIQUE INDEX UNIQ_CAC89EAC94E0409D (workflow_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sites (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', workflow_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', is_active TINYINT(1) DEFAULT \'1\' NOT NULL, code VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description MEDIUMTEXT DEFAULT NULL, url VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, sort INT DEFAULT 100 NOT NULL, UNIQUE INDEX UNIQ_BC00AA6377153098 (code), UNIQUE INDEX UNIQ_BC00AA6394E0409D (workflow_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE users_accounts ADD CONSTRAINT FK_B189B576ABFE1C6F FOREIGN KEY (user_uuid) REFERENCES users (uuid)');
        $this->addSql('ALTER TABLE users_accounts ADD CONSTRAINT FK_B189B5765DECD70C FOREIGN KEY (account_uuid) REFERENCES accounts (uuid)');
        ...
        $this->addSql('ALTER TABLE accounts ADD CONSTRAINT FK_CAC89EAC94E0409D FOREIGN KEY (workflow_uuid) REFERENCES workflow (uuid)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE accounts DROP FOREIGN KEY FK_CAC89EAC94E0409D');
        ...
        $this->addSql('ALTER TABLE storage_roles DROP FOREIGN KEY FK_DBEAE7E76FC02232');
        ...
        $this->addSql('ALTER TABLE storage_roles DROP FOREIGN KEY FK_DBEAE7E7D8529BB3');
        ...
        $this->addSql('ALTER TABLE users_accounts DROP FOREIGN KEY FK_B189B576ABFE1C6F');
        ...
        $this->addSql('ALTER TABLE users_accounts DROP FOREIGN KEY FK_B189B5765DECD70C');
        ...
        $this->addSql('DROP TABLE users_accounts');
